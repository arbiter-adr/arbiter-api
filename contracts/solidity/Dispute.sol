...
contract Dispute is Claim {
    ...
    struct Claim {
        Claimant claimant; // Exactly One claimant per Dispute (two disputes against same person if multiple, resolved separately);
